...
botonConfirmar.addEventListener(
  ...
  async function () {
    ...
    try {
       ...
       * IMPORTANTE:
       *
       * Después de confirmar el asiento
       * mostramos el botón de pago.
       *
       * El botón queda preparado para que
       * el Integrante #3 conecte su módulo.
       */
      if (resumenAsiento) {
        ...
        resumenAsiento.innerHTML = `
          ...
          >
            ...
            El módulo de pago será conectado
            por el Integrante #3.
        ...
        /*
         * El botón existe visualmente,
         * pero NO realiza ninguna acción todavía.
         *
         * Esto permite que el Integrante #3
         * conecte posteriormente su módulo.
         */
        ...
        if (btnProcederPago) {
          ...
          btnProcederPago.addEventListener(
            ...
            function () {
              ...
              console.log(
                "Módulo de pago pendiente de integración.",
                {
                  reservaId:
                    reserva?.id,
                  vueloId:
              ...
              window.alert(
                "El módulo de pago será conectado por el Integrante #3."
              );
